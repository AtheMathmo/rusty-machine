...
use rm::learning::k_means::{Forgy, KPlusPlus, RandomPartition};
...
fn test_two_centroids() {
    ...
    let inputs = Matrix::new(
        ...
        2,
        vec![
            59.59375, 270.6875, 51.59375, 307.6875, 86.59375, 286.6875, 319.59375, 145.6875,
            314.59375, 174.6875, 350.59375, 161.6875,
        ],
    );
